			...
			if (null != task.getTaskResult()) {
				...
				if (getdata.get("Error") == null) {
					...
					if (Integer.parseInt(getdata.get("I_ReturnValue")
						...
						String str = getdata.get("I_ReturnMessage");
						logSysDetails(str, "成功");
						if(str.contains("OPPO重复装车")){
							SoundEffectPlayService
							.playLaserSoundEffect(SoundEffectPlayService.SoundPoolResource.ALARM_MUSIC);
							Log.i("SNTOCAR", "HERE PLAY SOUND!");
							AlertDialog.Builder builder=new AlertDialog.Builder(this);
							builder.setTitle("---oppo单板条码重复---");
							builder.setMessage("这里有发现OPPO单板条码重复，该单板条码已锁定！");
