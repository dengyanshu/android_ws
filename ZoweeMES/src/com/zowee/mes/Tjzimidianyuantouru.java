...
//电源投入程序
public class Tjzimidianyuantouru extends CommonActivity implements
	...
	private  TextView  textviewnmo;//点击工单
	private EditText editMOProduct;
	private EditText editMOgongzuoliu;
	...
	private TjzimidianyuantouruModel tjzimidianyuantouruModel; // 任务处理类
	private  Common4dModel  common4dmodel;
	private static final String TAG = "Tjzimidianyuantouru";

	@Override
	protected void onCreate(Bundle savedInstanceState) {

		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_tianji_zimidianyuantouru);
		init();
	}
				...
				.setPositiveButton(getString(android.R.string.yes),
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								stopService(new Intent(Tjzimidianyuantouru.this,
	...
	public void init() {
		...
		super.TASKTYPE = TaskType.tjzimidianyuantouru; // 后台服务静态整形常量
		super.init();

		tjzimidianyuantouruModel = new TjzimidianyuantouruModel();
		common4dmodel=new  Common4dModel();
		
		editMO = (EditText) findViewById(R.id.tjzimidianyuantouru_moedit);
		textviewnmo=(TextView) findViewById(R.id.tjzimidianyuantouru_motextview);
		editMOgongzuoliu = (EditText) findViewById(R.id.tjzimidianyuantouru_mogongzuoliuedit);
		editMOProduct = (EditText) findViewById(R.id.tjzimidianyuantouru_moproductedit);

		
		editsn = (EditText) findViewById(R.id.tjzimidianyuantouru_snedit);
		editscan=(EditText) findViewById(R.id.tjzimidianyuantouru_editscan);
		editscan.setFocusable(false);
		
		textviewnmo.setOnClickListener(this);
	...
	public void refresh(Task task) {
		...
		case TaskType.tjzimidianyuantourugetmo:
			super.closeProDia();
		...
		case TaskType.tjzimidianyuantouru:
			super.closeProDia();
			if (null != task.getTaskResult()) {
				getdata = (HashMap<String, String>) task.getTaskResult();
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.tjzimidianyuantouru_motextview:
	...
	public boolean onKey(View v, int keycode, KeyEvent event) {
		switch (v.getId()) {
		case R.id.tjzimidianyuantouru_moedit:
			...
			if (KeyEvent.KEYCODE_ENTER == keycode
			   ...
			   if(param.length()<8){
				   Toast.makeText(this, "批次号长度不对", Toast.LENGTH_SHORT).show();
					...
					super.showProDia();
					tjzimidianyuantouruModel.getMo(new Task(this,TaskType.tjzimidianyuantourugetmo,param));
			   }
			}
			break;

		case R.id.tjzimidianyuantouru_snedit:
			String[]  params=new String[7];
			if (KeyEvent.KEYCODE_ENTER == keycode
					&& event.getAction() == KeyEvent.ACTION_DOWN) {
				if(moid==null||moname==null){
					Toast.makeText(this, "请先获取工单id和工单名", Toast.LENGTH_LONG).show();
				}
				else{
					super.progressDialog.setMessage("电源SN投入工作提交中....");
					super.showProDia();
					params[0] = useid;
					params[1] = usename;
					params[2] = resourceid;
					...
					tjzimidianyuantouruModel.dianyuantouru(new  Task(this,TaskType.tjzimidianyuantouru,params));
				}
			}
			break;
		}
