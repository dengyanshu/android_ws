		...
		TaskOperator taskOperator = new TaskOperator() {
			...
			public Task doTask(Task task) {
				try {
					...
					soap.addWsProperty(
							"SQLString",
							"declare @I_ReturnMessage nvarchar(max) = ' '  declare @res int declare @I_ExceptionFieldName nvarchar(100) exec @res = Txn_DataChainProdentry '', @I_ReturnMessage out,@I_ExceptionFieldName  out,'1','','"
									+ userID
									+ "','"
									+ UserName
									+ "','','','','','','','"
