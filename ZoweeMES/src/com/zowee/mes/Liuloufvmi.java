...
public class Liuloufvmi extends CommonActivity implements
	...
	private LiuloufvmiModel liuloufvmiModel; // 任务处理类
	...
	public void init() {
		...
		if(fvmitype.equals("1")){
			titletextview.setText("开机测试");
			okbutton.setText("开机测试");
		}
		if(fvmitype.equals("2")){
			titletextview.setText("功能测试");
			okbutton.setText("功能测试");
		}
		if(fvmitype.equals("3")){
			titletextview.setText("目检");
			okbutton.setText("目检");
		}
