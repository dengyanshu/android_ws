 ...
 */
public class FinishOutCardActivity extends CommonActivity implements
	...
	public void refresh(Task task) {
		...
		case TaskType.FINISHOUTCARD_SCAN:
			...
			// showProDia();
			// Task getParams = new Task(this, TaskType.FINISHOUTCARD_GETPARAMS,
			// cardSN);//创建一个获取卡板出库参数的任务
		...
		case TaskType.FINISHOUTCARD_GETPARAMS:
			...
			FinishOutCardOrdersAdapter orderAdapter = new FinishOutCardOrdersAdapter(
					this, orderLisMaps);
		...
		case TaskType.FINISHOUTCARD_GETDNNAMES:
			...
			FinishOutCardDNNamesAdapter dnAdapter = new FinishOutCardDNNamesAdapter(
					this, dnLisMaps);
	...
	// //FinishOutCattonDNNamesAdapter adapter = new
	// FinishOutCattonDNNamesAdapter(finOutNums, this);
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		Log.i(TAG, " " + " " + selOutNum + " " + customerName + " "
				+ customeDescri + " sorootid: " + soRootId);
		if (StringUtils.isEmpty(customeDescri))
			customeDescri = "";
		if (StringUtils.isEmpty(customerName))
			customerName = "";
		String curDate = DateUtils.conDateToStr(
				new Date(System.currentTimeMillis()), "yyyy-MM-dd");
		if (!StringUtils.isEmpty(curDate))
			edtDatetime.setText(curDate);
	...
	public void onClick(View v) {
		...
		case R.id.btn_refreshData:
			...
			// {
			// Toast.makeText(this, R.string.cardSN_notnull,
	...
	private AdapterView.OnItemSelectedListener orderAdapterLis = new AdapterView.OnItemSelectedListener() {
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
			...
			// showProDia();
			// Task task = new
			// Task(FinishOutCardActivity.this,TaskType.FINISHOUTCARD_GETDNNAMES,soRootId);
	...
	private boolean subUIData() {
		...
		if (!isPass) {
			Toast.makeText(this, getString(R.string.cardSN_notnull), 1500)
					.show();
			return isPass;
		}
	...
	public void onFocusChange(View v, boolean hasFocus) {
		...
		case R.id.edt_cardnum:
			...
			if (edtCard.isFocused()
					&& StringUtils.isEmpty(edtCard.getText().toString())) {
				edtOperDetails.setText(edtOperDetails.getText().toString()
						+ getString(R.string.please_scan) + " "
						+ getString(R.string.card_num) + "\n\n");
				return;
			}
			break;
		}
	...
	private void getDNNames() {
		...
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task getParams = new Task(this, TaskType.FINISHOUTCARD_GETDNNAMES,
