 ...
 */
public class LaserFunctionConfigActivity extends Activity implements
		CommonActivityInterface, RadioGroup.OnCheckedChangeListener,
	...
	public void init() {
		...
		if (isEnable)
			rbLaserOn.setChecked(true);
		else
			rbLaserOff.setChecked(true);
	...
	public void onClick(View v) {
		...
		case R.id.btn_update:
			...
			LaserScanOperator.changeLaserEnable(LaserConfigParser
					.getLaserFunctionEnable());
