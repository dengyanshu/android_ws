 ...
 * @description 卡板发货
 */
public class FinishDeliCardActivity extends CommonActivity implements
	...
	public void refresh(Task task) {
		...
		case TaskType.FINISHDELICARD_SCAN:
			...
			// TaskType.FINISHDELICARD_GETPARAMS, cardSN);
		...
		case TaskType.FINISHDELICARD_GETPARAMS:
			...
			FinishDeliCardOrdersAdapter orderAdapter = new FinishDeliCardOrdersAdapter(
					this, orderLisMaps);
	...
	private AdapterView.OnItemSelectedListener orderAdapterLis = new AdapterView.OnItemSelectedListener() {
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
			...
			// showProDia();
			// Task task = new
			// Task(FinishDeliCardActivity.this,TaskType.FINISHDELICARD_GETDNNAMES,soRootId);
	...
	// super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
	// showProDia();
	// Task getParams = new Task(this, TaskType.FINISHDELICARD_GETPARAMS,
	// cardSN);
	// model.getNecessParams(getParams);
	//
	// }
	...
	private void getDNNames() {
		...
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task getParams = new Task(this, TaskType.FINISHDELICARD_GETDNNAMES,
