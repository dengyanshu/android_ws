 ...
 */
public class MESPDAUpdateConfigActivity extends Activity implements
		CommonActivityInterface, View.OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_update:
			...
			Toast.makeText(this, R.string.mesupdate_setting_success, 1500)
					.show();
			break;
		...
		case R.id.btn_restore:
			...
			Toast.makeText(this, R.string.mesupdate_setting_restore, 1500)
					.show();
			break;
		}
	}
