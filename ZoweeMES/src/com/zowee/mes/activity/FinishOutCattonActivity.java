 ...
 * @description 卡通箱成品出库
 */
public class FinishOutCattonActivity extends CommonActivity implements
	...
	public void refresh(Task task) {
		...
		case TaskType.FINISHOUTCARTOON_SCAN:
			...
			// TaskType.FINISHOUTCARTOON_GETPARAMS, catBoxSN);
		...
		case TaskType.FINISHOUTCARTOON_SONAMES:
			...
			FinishOutCattonOrdersAdapter orderAdapter = new FinishOutCattonOrdersAdapter(
					this, orderLisMaps);
		...
		case TaskType.FINISHOUTCARTOON_GETDNNAMES:
			...
			FinishOutCattonDNNamesAdapter dnAdapter = new FinishOutCattonDNNamesAdapter(
					this, dnLisMaps);
	...
	private AdapterView.OnItemSelectedListener orderAdapterLis = new AdapterView.OnItemSelectedListener() {
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
			...
			// showProDia();
			// Task task = new
			// Task(FinishOutCattonActivity.this,TaskType.FINISHOUTCARTOON_GETDNNAMES,soRootId);
	...
	private void refData(String catBoxSN) {
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task getParams = new Task(this, TaskType.FINISHOUTCARTOON_SONAMES,
				catBoxSN);
		model.getNecesParams(getParams);
	...
	private void getDNNames() {
		...
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task getParams = new Task(this, TaskType.FINISHOUTCARTOON_GETDNNAMES,
