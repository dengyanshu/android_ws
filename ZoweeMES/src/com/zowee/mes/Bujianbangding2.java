...
import com.zowee.mes.model.Bujianbangding2Model;
...
//六楼联想组装 整机部件条码绑定2 整机SN 后盖 喇叭


public class Bujianbangding2 extends CommonActivity implements
	...
	private  EditText  editlabasn;
	private  EditText  edithougaisn;

	private EditText editscan;

	private AssyqidongModel assyqidongModel; // 任务处理类
	private  Common4dModel  common4dmodel;
	private   Bujianbangding2Model  bujianbangding2Model;
	private static final String TAG = "Bujianbangding2";

	@Override
	protected void onCreate(Bundle savedInstanceState) {

		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_liulou_bujianbangding2);
		init();
	}
				...
				.setPositiveButton(getString(android.R.string.yes),
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								stopService(new Intent(Bujianbangding2.this,
	...
	public void init() {
		...
		bujianbangding2Model=new Bujianbangding2Model();
		...
		editsn = (EditText) findViewById(R.id.bujianbangding_zhengjisn);
		editlabasn = (EditText) findViewById(R.id.bujianbangding_labasn);
		edithougaisn = (EditText) findViewById(R.id.bujianbangding_hougaisn);
		
		editscan = (EditText) findViewById(R.id.bujianbangding_editscan);
		editscan.setFocusable(false);
		
		edithougaisn.setOnKeyListener(this);
...
//					editsn.setText("");
	...
	public boolean onKey(View v, int keycode, KeyEvent event) {
		...
		case R.id.bujianbangding_zhengjisn:
			...
			if (KeyEvent.KEYCODE_ENTER == keycode
			   ...
			   if(moname==null||moid==null){
				   Toast.makeText(this, "请先获取工单信息！", Toast.LENGTH_SHORT).show();
					...
					params[4] = param2;
					params[5] = editlabasn.getText().toString().trim();
					params[6] = edithougaisn.getText().toString().trim();
					bujianbangding2Model.bujianbangding(new Task(this,TaskType.liuloubujianbangding,params));
			   }
			}
		break;
		}
