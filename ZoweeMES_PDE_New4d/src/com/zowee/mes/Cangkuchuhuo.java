...
public class Cangkuchuhuo extends CommonActivity implements
		OnKeyListener
		 {
				...
				.setPositiveButton(getString(android.R.string.yes),
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								stopService(new Intent(Cangkuchuhuo.this,
	...
	public boolean onKey(View v, int keycode, KeyEvent event) {
		...
		case R.id.ckchuhuo_poedit:
			...
			if (KeyEvent.KEYCODE_ENTER == keycode
				    ...
				    super.progressDialog.setMessage("正在获取信息...");
					super.showProDia();
					smtIPQCModel.getPO(new Task(this,10010,sn));
		...
		case R.id.ckchuhuo_box4:
			...
			if (KeyEvent.KEYCODE_ENTER == keycode
				...
				paras[10]=box4.getText().toString();
				  ...
				  super.progressDialog.setMessage("正在获取信息...");
					super.showProDia();
					smtIPQCModel.canzhanban(new Task(this,10086,paras));
