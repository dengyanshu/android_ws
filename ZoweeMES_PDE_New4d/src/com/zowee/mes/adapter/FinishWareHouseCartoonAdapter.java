 ...
 */
public class FinishWareHouseCartoonAdapter extends CommonSpinnerAdapter<HashMap<String,String>> 
{

	//private static final String PRODUCTCOMPLETEID = "ProductCompleteID";
	private static final String COMPLETEDOCNO = "CompleteDocNo";
	
	public FinishWareHouseCartoonAdapter(Context context,List<HashMap<String,String>> lisMaps)
	{
