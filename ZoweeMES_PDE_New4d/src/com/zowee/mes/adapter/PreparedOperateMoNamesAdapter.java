 ...
 */
public class PreparedOperateMoNamesAdapter extends CommonSpinnerAdapter<HashMap<String,String>> 
{
	
	private final static String MONAME = "MOName";
	
	public PreparedOperateMoNamesAdapter(Context context,List<HashMap<String,String>> lisMaps)
	{
