 ...
 */
public class workcenterAdapter extends CommonSpinnerAdapter<HashMap<String,String>> 
{
	
 
	
	public workcenterAdapter(Context context,List<HashMap<String,String>> lisMaps)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		String  viewText = lsItem.get("WorkcenterName");
