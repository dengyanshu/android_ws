 ...
 * @description 卡板出库 - 订单名称的数据适配器
 */
public class FinishOutCardOrdersAdapter extends CommonSpinnerAdapter<HashMap<String,String>> 
{
	
	private final static String SOROOTNAME = "SORootName";
	
	public FinishOutCardOrdersAdapter(Context context,List<HashMap<String,String>> lisMaps)
	{
