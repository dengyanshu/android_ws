 ...
 * @description 卡通发货 - 订单名称的数据适配器
 */
public class FinishDeliCattonOrdersAdapter extends CommonSpinnerAdapter<HashMap<String,String>> 
{
	
	private final static String SOROOTNAME = "SORootName";
	
	public FinishDeliCattonOrdersAdapter(Context context,List<HashMap<String,String>> lisMaps)
	{
