...
public class FifoAdapter extends BaseAdapter 
{
	...
	public FifoAdapter(List<HashMap<String,String>> fifoScanRes,Context context)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		TextView labStockLoction = (TextView)view.findViewById(R.id.labStockLocation);
		HashMap<String,String> fifoResItem = this.fifoScanRes.get(position);
		labBoxSn.setText(fifoResItem.get(BOXSN)==null?"":fifoResItem.get(BOXSN));
		labLotSn.setText(fifoResItem.get(LOTSN)==null?"":fifoResItem.get(LOTSN));
		labStockLoction.setText(fifoResItem.get(STOCKLOCATION)==null?"":fifoResItem.get(STOCKLOCATION));
