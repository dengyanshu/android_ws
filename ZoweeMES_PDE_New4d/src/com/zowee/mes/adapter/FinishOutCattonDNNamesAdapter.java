 ...
 */
public class FinishOutCattonDNNamesAdapter extends CommonSpinnerAdapter<HashMap<String,String>>
{
	 
	private final static String DNNAME = "DNName";
	
	public FinishOutCattonDNNamesAdapter(Context context,List<HashMap<String,String>> lisMaps)
	{
