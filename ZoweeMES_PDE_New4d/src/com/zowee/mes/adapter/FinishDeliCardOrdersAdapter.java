 ...
 */
public class FinishDeliCardOrdersAdapter extends CommonSpinnerAdapter<HashMap<String,String>> 
{
	
	private final static String SOROOTNAME = "SORootName";
	
	public FinishDeliCardOrdersAdapter(Context context,List<HashMap<String,String>> lisMaps)
	{
