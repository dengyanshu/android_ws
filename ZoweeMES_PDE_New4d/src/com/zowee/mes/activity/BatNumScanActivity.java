 ...
 * @description 
 */
public class BatNumScanActivity extends CommonActivity  implements View.OnClickListener 
{
	...
	public void init()
	{
		...
		edtSysDetail = (EditText)this.findViewById(R.id.common_edtView_operateDetails).findViewById(R.id.edt_sysdetail);
...
//				//Task getLotSNImforTask = new Task(this, TaskType.BATNUM_INFOR,"Mxxxxxx5");
	...
	public void onClick(View v)
	{
		switch(v.getId())
		{
			...
			case R.id.btn_ensure:
				...
				{
					Toast.makeText(this, R.string.batNum_notNull, Toast.LENGTH_SHORT).show();
					return;
				}
				refData(lotSN);
				break;
