...
public class FifoScanActivity extends CommonActivity implements View.OnClickListener
{
...
//	private ProgressDialog progressDialog;
	...
	public void init()
	{
		...
		edtSmalPacBarCode =(EditText)this.findViewById(R.id.edt_smalpac_barcode);
		...
		((TextView)headView.findViewById(R.id.labBoxSn)).setText(this.getString(R.string.boxSn));
		((TextView)headView.findViewById(R.id.labLotSn)).setText(this.getString(R.string.lotSn));
		((TextView)headView.findViewById(R.id.labStockLocation)).setText(this.getString(R.string.stockLocation));
...
//				fifoModel.fifoScan(fifoScan);
			...
			case TaskType.FIFO_SCAN_DATA:
				...
				{
					Task viewFifoResTask = new Task(this,TaskType.VIEW_FIFO_RES,task.getTaskResult());
			...
			case TaskType.VIEW_FIFO_RES:
				...
				if(null!=task.getTaskResult())
				{
					List<HashMap<String,String>> fifoScanRes = (List<HashMap<String,String>>)task.getTaskResult();
					labFifoRes.setText(labFifoRes.getText().toString()+fifoScanRes.size());
				...
				else
				{
					...
					labFifoRes.setText(labFifoRes.getText()+this.getString(R.string.fifoScanLotSnError));
				}
	...
	public void onClick(View v) 
	{
		switch(v.getId())
		{
			...
			case R.id.btn_ensure:
				...
				{
					Toast.makeText(this, R.string.smallBag_notNull,Toast.LENGTH_SHORT).show();
					return;
				}
				refData(lotSN);
				break;
