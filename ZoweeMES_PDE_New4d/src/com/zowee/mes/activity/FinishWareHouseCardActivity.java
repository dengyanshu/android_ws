 ...
 * @description 卡板成品入仓
 */
public class FinishWareHouseCardActivity extends CommonActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener,View.OnFocusChangeListener
{
...
//				showProDia();
//				Task getParamsTask = new Task(this, TaskType.FINISHWAREHOUSECARD_GETPARAMS, boxSN);
//				model.getNecesParams(getParamsTask);
			...
			case TaskType.FINISHWAREHOUSECARD_GETCOMPLETENAMES:
				...
				FinishWareHouseCartoonAdapter adapter = new FinishWareHouseCartoonAdapter(this,spinLis);
			...
			case TaskType.FINISHWAREHOUSECARD_MONAME:
				...
				FinishWareHouseMoAdapter adapter_1 = new FinishWareHouseMoAdapter(this, spinLisMoNames);
...
//				{
//					Toast.makeText(this, R.string.cartoonbox_notnull, Toast.LENGTH_SHORT).show();
//					return;
//				}
//				refData(boxSN);
				dialog.show();
	...
	AdapterView.OnItemSelectedListener  moAdapterLis =  new AdapterView.OnItemSelectedListener() 
	{
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) 
		{
			...
			//showProDia();
//			Task task = new Task(FinishWareHouseCardActivity.this,TaskType.FINISHWAREHOUSECARD_DOCNOS,params);
//			model.getCompleteDocNos(task);
	...
	private void getCompleteNames(String checkStr)
	{
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task getParamsTask = new Task(this, TaskType.FINISHWAREHOUSECARD_GETCOMPLETENAMES,checkStr);
	...
	private void getMoNames(String completeId)
	{
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task task = new Task(this, TaskType.FINISHWAREHOUSECARD_MONAME, completeId);
