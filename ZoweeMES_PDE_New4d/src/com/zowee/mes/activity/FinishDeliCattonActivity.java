 ...
 * @description  卡通箱发货
 */
public class FinishDeliCattonActivity extends CommonActivity implements AdapterView.OnItemSelectedListener,View.OnClickListener,View.OnFocusChangeListener
{
...
//				showProDia();
//				Task getParams = new Task(this, TaskType.FINISHDELICARTOON_GETPARAMS, catBoxSN);
//				model.getNecessParams(getParams);
			...
			case TaskType.FINISHDELICARTOON_SONAMES:
			    ...
			    FinishDeliCattonOrdersAdapter orderAdapter = new FinishDeliCattonOrdersAdapter(this, orderLisMaps);
			...
			case TaskType.FINISHDELICARTOON_GETDNNAMES:
				...
				FinishDeliCattonDNNamesAdapter dnAdapter = new FinishDeliCattonDNNamesAdapter(this, dnLisMaps);
...
//				refData(catBoxSN);
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,long arg3)
	{
		...
		Log.i(TAG, " "+ " "+selOutNum +" "+customerName +" "+customDescri+" "+soRootId);
		if(StringUtils.isEmpty(customDescri)) customDescri = "";
...
//			showProDia();
//			Task task = new Task(FinishDeliCattonActivity.this,TaskType.FINISHDELICARTOON_GETDNNAMES,soRootId);
//			model.getDNNames(task);
			//select d.DNName as DNName,ct.CustomerName as CustomerName,ct.CustomerDescription as CustomerDescription from DN d inner join Customer ct on d.CustomerID = ct.CustomerId where d.SORootID = @soRootId
		}
...
//	}
	...
	private void getDNNames()
	{
		...
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task getParams = new Task(this, TaskType.FINISHDELICARTOON_GETDNNAMES, checkStr);//创建一个获取卡板 出货单号的任务
	...
	private void getSONames(String soRootId)
	{
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task getParams = new Task(this, TaskType.FINISHDELICARTOON_SONAMES, soRootId);//
		model.getNecessParams(getParams);
