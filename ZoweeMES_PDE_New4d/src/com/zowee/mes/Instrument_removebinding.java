...
public class Instrument_removebinding extends CommonActivity implements
		OnKeyListener
		 {
   ...
   private  EditText  editscan;
	...
	private static final String TAG = "Instrument_removebinding";

	@Override
	protected void onCreate(Bundle savedInstanceState) {

		super.onCreate(savedInstanceState);
		this.setContentView(R.layout.activity_instrument_removebinding);
		init();
	}
				...
				.setPositiveButton(getString(android.R.string.yes),
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								stopService(new Intent(Instrument_removebinding.this,
	...
	public void init() {
	    ...
	    snedit=(EditText) findViewById(R.id.instrument_removebinding_sn);
	    workcenteredit=(EditText) findViewById(R.id.instrument_removebinding_workcenter);
	    button=(Button) findViewById(R.id.instrument_removebinding_button);
	   
		editscan=(EditText) findViewById(R.id.instrument_linesetup_editscan);
		editscan.setText("使用说明：\n1、请检查该电脑的设置的资源名称是否正确、合法、有注册！\n2、系统会自动根据资源名称检测工作中心，请先获取正确的工作中心，再开始设备解除绑定操作！");
	...
	public void refresh(Task task) {
		...
		case TaskType.instrumentremovebinding:
			super.closeProDia();
   ...
   private void removebinding(final String[] paras){
	     ...
	     builder.setPositiveButton("确定", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
			    ...
			    showProDia();
			    instrumentModel.removebinding(new  Task(Instrument_removebinding.this,TaskType.instrumentremovebinding,paras));
			}
		});
	...
	public boolean onKey(View v, int keycode, KeyEvent event) {
		switch (v.getId()) {
		case R.id.instrument_removebinding_sn:
