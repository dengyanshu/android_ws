...
public class Tjzimirepairin extends CommonActivity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tjzimi_repairin);
		init();
				...
				.setPositiveButton(getString(android.R.string.yes),
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								stopService(new Intent(Tjzimirepairin.this,
	...
	public void init() {
		...
		editmo = (EditText) findViewById(R.id.tjzimi_repairin_mo);

		linebutton = (Button) findViewById(R.id.tjzimi_repairin_linebutton);
		linename = (EditText) findViewById(R.id.tjzimi_repairin_line);
		linename.setEnabled(false);

		radiogroup = (RadioGroup) findViewById(R.id.tjzimi_repairin_radiogroup);
		radiobutton1 = (RadioButton) findViewById(R.id.tjzimi_repairin_radio1);
		radiobutton2 = (RadioButton) findViewById(R.id.tjzimi_repairin_radio2);
		...
		sn = (EditText) findViewById(R.id.tjzimi_repairin_sn);

		button = (Button) findViewById(R.id.tjzimi_repairin_selectbutton);
		selcetedit1 = (EditText) findViewById(R.id.tjzimi_repairin_selectedit1);
		selcetedit1.setEnabled(false);
		selcetedit2 = (EditText) findViewById(R.id.tjzimi_repairin_selectedit2);
		selcetedit2.setEnabled(false);
		spinner = (Spinner) findViewById(R.id.tjzimi_repairin_spinner);
		...
		editscan = (EditText) findViewById(R.id.tjzimi_repairin_scan);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.tjzimi_repairin_linebutton:
		...
		case R.id.tjzimi_repairin_selectbutton:
	...
	public void onItemSelected(AdapterView<?> spinner, View arg1, int arg2,
		...
		switch (id) {
		case R.id.tjzimi_repairin_spinner:
