...
//四楼贴标转（光模块）-转DSN-无
public class Tiebiaozhuandsn extends CommonActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_silou_tiebiaozhuandsn);
		init();
	}
				...
				.setPositiveButton(getString(android.R.string.yes),
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								stopService(new Intent(Tiebiaozhuandsn.this,
