...
public class Tjzimiproduct extends CommonActivity implements OnClickListener,
	...
	private String moid;
	private  String moname;//通过lotsn获取工单名称，工单id，产品码 ，产品码有可能为NULL!5月22日修改
	private  String  productma;//通过工单获取产品码，5.14日修改！！
		...
		case TaskType.linegetmo:
			...
			if (null != task.getTaskResult()) {
				...
				if (getdata.containsKey("MOId")){
					...
					logSysDetails("该工单成功在MES查询到该工单的id为" + moid+"，产品码为"+productma,"成功");
