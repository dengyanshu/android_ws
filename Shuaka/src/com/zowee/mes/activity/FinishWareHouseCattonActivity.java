 ...
 * @description 卡通箱成品入仓
 */
public class FinishWareHouseCattonActivity extends CommonActivity implements
	...
	public void refresh(Task task) {
		...
		case TaskType.FINISHWAREHOUSECARTOON_SCAN:
			...
			// TaskType.FINISHWAREHOUSECARTOON_GETPARAMS, boxSN);
		...
		case TaskType.FINISHWAREHOUSECARTOON_MONAME:
			...
			FinishWareHouseMoAdapter adapter = new FinishWareHouseMoAdapter(
					this, spinLisMoNames);
		...
		case TaskType.FINISHWAREHOUSECARTOON_DOCNOS:
			...
			FinishWareHouseCartoonAdapter adapter_1 = new FinishWareHouseCartoonAdapter(
					this, spinLis);
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		// /Toast.makeText(this, ""+productCompleteId+" "+completeDocNo,
		// 1000).show();
	}
	...
	AdapterView.OnItemSelectedListener moAdapterLis = new AdapterView.OnItemSelectedListener() {
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
			...
			// showProDia();
			// Task task = new
			// Task(FinishWareHouseCattonActivity.this,TaskType.FINISHWAREHOUSECARTOON_DOCNOS,params);
	...
	private void getCompleteNames(String checkStr) {
		...
		showProDia();
		Task getParamsTask = new Task(this,
				TaskType.FINISHWAREHOUSECARTOON_DOCNOS, checkStr);
	...
	private void getMoNames(String completeId) {
		super.progressDialog.setMessage(getString(R.string.loadAppNecessData));
		showProDia();
		Task task = new Task(this, TaskType.FINISHWAREHOUSECARTOON_MONAME,
				completeId);
