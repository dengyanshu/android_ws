 ...
 */
public class LaserConfigActivity extends CommonActivity implements
	...
	public void onClick(View v) {
		...
		case R.id.btn_update:
			...
			int baudRate = Integer.valueOf(edtBaurate.getText().toString()
					.trim());
			int timeOut = Integer.valueOf(edtTimeout.getText().toString()
					.trim());
			int dataBits = Integer.valueOf(edtDatabits.getText().toString()
					.trim());
			int endBits = Integer.valueOf(edtEndbits.getText().toString()
					.trim());
			int parity = Integer.valueOf(edtPriority.getText().toString()
					.trim());
			int flowControl = Integer.valueOf(edtFlowControl.getText()
					.toString().trim());
			SerialParams serialParams = new SerialParams(name, owner, timeOut,
					baudRate, dataBits, endBits, parity, flowControl);
			...
			Toast.makeText(this, R.string.laserConfig_Success,
		...
		case R.id.btn_restore:
			SerialParams originalSerialParams = LaserConfigParser
					.getLaserConfig();
			LaserConfigParser.mergeLaserConfig(originalSerialParams);
			initUIData(LaserConfigParser.getFinalSerialParams());
			LaserScanOperator.setSerialParams(LaserConfigParser
					.getFinalSerialParams());
	...
	private boolean subUIData() {
		...
		if (!isPass) {
			Toast.makeText(this, R.string.serialName_isnull, Toast.LENGTH_SHORT)
					.show();
			return isPass;
		}
		...
		if (!isPass) {
			Toast.makeText(this, R.string.owner_isnull, Toast.LENGTH_SHORT)
					.show();
			return isPass;
		}
		...
		if (!isPass) {
			Toast.makeText(this, R.string.baurate_isnull, Toast.LENGTH_SHORT)
					.show();
			return isPass;
		}
		...
		if (!isPass) {
			Toast.makeText(this, R.string.timeout_isnull, Toast.LENGTH_SHORT)
					.show();
			return isPass;
		}
		...
		if (!isPass) {
			Toast.makeText(this, R.string.databits_isnull, Toast.LENGTH_SHORT)
					.show();
			return isPass;
		}
		...
		if (!isPass) {
			Toast.makeText(this, R.string.endbits_isnull, Toast.LENGTH_SHORT)
					.show();
			return isPass;
		}
		...
		if (!isPass) {
			Toast.makeText(this, R.string.priority_isnull, Toast.LENGTH_SHORT)
					.show();
			return isPass;
		}
		...
		if (!isPass) {
			Toast.makeText(this, R.string.flowControl_isnull,
					Toast.LENGTH_SHORT).show();
			return isPass;
		}
