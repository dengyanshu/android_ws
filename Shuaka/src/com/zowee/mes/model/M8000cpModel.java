...
public class M8000cpModel extends CommonModel {

	public void getpath(Task task) {
		...
		TaskOperator taskOperator = new TaskOperator() {
			...
			public Task doTask(Task task) {
				try {
					...
					String moid = (String) task.getTaskData();

					String sql = "select Path from PackTemplate where ProductId=(select ProductId from MO where MOId='"+moid+"') and Category=(select ParameterId from SysParameter where ParameterValue='Nameplate') ";
