...
public class LenovotocarModel extends CommonModel {

	public void lenovotocar(Task task) {
		...
		TaskOperator taskOperator = new TaskOperator() {
			...
			public Task doTask(Task task) {
				try {
					...
					String carsn = Params[6];
					String snlist = Params[7];
					String numononepcba = Params[8];

					Log.i(TAG, "任务数据是:" + Params[0] + "," + Params[1] + ","
							+ Params[2] + "," + Params[3] + "," + Params[4]
							+ "," + Params[5]+Params[6]+Params[7]);

					String sql = " declare @res int declare @message nvarchar(max) declare @exception nvarchar(100)  exec @res= [Txn_DataChainLoadCarAndBindIC]    "
							+" @I_OrBitUserId='"+useid+"',@I_OrBitUserName='"+usename+"',@I_ResourceId='"+resourceid+"',@I_ResourceName='"+resourcename+"',"
							+ "@MOId='"+moid+"',@MOName='"+moname+"',@CarInfo='"+carsn+"',@LotSN='"+snlist+"',@ICQty="+numononepcba+",	"
