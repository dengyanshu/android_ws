...
public class XiaojiegouckpModel extends CommonModel {

	public void xiaojiegouckp(Task task) {
		...
		TaskOperator taskOperator = new TaskOperator() {
			...
			public Task doTask(Task task) {
				try {
					...
					String chanpinsn = Params[6];
					String chanpinmac = Params[7];
					...
					String sql = " declare @res int declare @message nvarchar(max) declare @exception nvarchar(100)  exec @res=Txn_ProductSNMACBoxSNCheck    "
							+" @I_OrBitUserId='"+useid+"',@I_OrBitUserName='"+usename+"',@I_ResourceId='"+resourceid+"',@I_ResourceName='"+resourcename+"',"
							+ "@MOId='"+moid+"',@MOName='"+moname+"',@ProductMAC='"+chanpinmac+"',@ProductSN='"+chanpinsn+"',@BoxSN='"+caihesn+"',"
