...
public class TjzimiweixiuModel extends CommonModel {


	
	
	public void zimiweixiu(Task task) {
		...
		TaskOperator taskOperator = new TaskOperator() {
			...
			public Task doTask(Task task) {
				try {
					...
					String sql = " declare @res int declare @message nvarchar(max)   exec @res= Txn_RepairZM    "
							+" @I_PlugInCommand='ZMREP',@I_OrBitUserId='"+useid+"',@I_OrBitUserName='"+usename+"',@I_ResourceId='"+resourceid+"',@I_ResourceName='"+resourcename+"',"
							+ "@PowerSN='"+sn+"',"
