...
public class Tjzimipower extends CommonActivity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tjzimi_power);
		init();
				...
				.setPositiveButton(getString(android.R.string.yes),
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								stopService(new Intent(Tjzimipower.this,
	...
	public void init() {
		...
		editmo = (EditText) findViewById(R.id.tjzimi_power_mo);

		linebutton = (Button) findViewById(R.id.tjzimi_power_linebutton);
		linename = (EditText) findViewById(R.id.tjzimi_power_linesn);
		linename.setEnabled(false);

		sn = (EditText) findViewById(R.id.tjzimi_power_sn);

		button = (Button) findViewById(R.id.tjzimi_power_selectbutton);
		button.setFocusable(false);
		selcetedit1 = (EditText) findViewById(R.id.tjzimi_power_selectedit1);
		selcetedit1.setEnabled(false);
		selcetedit2 = (EditText) findViewById(R.id.tjzimi_power_selectedit2);
		selcetedit2.setEnabled(false);
		spinner = (Spinner) findViewById(R.id.tjzimi_power_spinner);
		...
		editscan = (EditText) findViewById(R.id.tjzimi_power_scan);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.tjzimi_power_linebutton:
		...
		case R.id.tjzimi_power_selectbutton:
	...
	public boolean onKey(View v, int keycode, KeyEvent event) {
		...
		case R.id.tjzimi_power_mo:
			...
			break;
		case R.id.tjzimi_power_sn:

			if (KeyEvent.KEYCODE_ENTER == keycode
					&& event.getAction() == KeyEvent.ACTION_DOWN) {
				if (editmo.getText().toString().equals("")
						|| linename.getText().toString().equals("")) {
					Toast.makeText(this, "工单和线体不能为空", Toast.LENGTH_SHORT)
							.show();
				}
	...
	public void onItemSelected(AdapterView<?> spinner, View arg1, int arg2,
		...
		switch (id) {
		case R.id.tjzimi_power_spinner:
