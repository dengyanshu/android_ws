...
public final class Shuaka extends CommonActivity implements
	...
	private  Handler  handler=new Handler();
	 ...
	 private  boolean flag_netfail=false;  
...
//		System.out.println(s.equals("")); 
   ...
   public void  shua(View  v){
	     shuakaModel.getmoname(new Task(this,TaskType.shuaka_getmoname,new String[]{paras[0],day}));
		//选取制程为请选择
		 paras[3]="";
...
//		});
		 ...
		 adapter=new  SimpleAdapter(this, res, R.layout.activity_shuaka_adapter,new String[]{"Id","name","MoName","WorkprocedureFlowList","ActionName","ActionTime"},new  int[]{R.id.shuaka_adapter_1,R.id.shuaka_adapter_2,
				 R.id.shuaka_adapter_3,R.id.shuaka_adapter_4,R.id.shuaka_adapter_5,R.id.shuaka_adapter_6});
		 lv.setAdapter(adapter);
		  ...
		  bar=(SeekBar) findViewById(R.id.shuaka_ratingbar);
		  ...
		  day_tv=(TextView) findViewById(R.id.shuaka_bar_tv2);
...
//							 adapter.notifyDataSetChanged();
				 ...
				 new AlertDialog.Builder(this)
					.setTitle("网络失败")
					.setMessage("   网络连接失败，请联系工程人员，检查网口是否松动，MES服务器是否正常可用？？？")
					.setPositiveButton("重启平板",
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
										int which) {
//									PowerManager pm = (PowerManager)Shuaka.this.getApplicationContext().getSystemService(Context.POWER_SERVICE);
//									pm.reboot("reboot");   
	...
	private  void  getlistdata(String[] para){
		shuakaModel.getlistdata(new  Task(this,100,para));
	}
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		case  R.id.shuaka_moname:
			...
			if(!item.contains("选择")){
				paras[2]=item;
				//获取制程
				shuakaModel.getzhicheng(new Task(this,TaskType.shuaka_getzhicheng,new  String[]{paras[0],paras[2],day}));
			}
			else{
				paras[2]="";
			}
				...
				case 1:
					  ...
					  if(message.contains("@c")){
						// logSysDetails("读刷卡机的内容是！"+message, "指令");
						  ...
						  //Toast.makeText(Shuaka.this, "刷卡信息是！"+message, Toast.LENGTH_LONG).show();
						  //刷卡信息过来
						 ...
						 try{
							...
							// TODO: handle exception
							 Toast.makeText(Shuaka.this, "员工卡号信息解析异常", 1).show();
						}
						 if(paras[5].equals("")||paras[3].equals("")){
							  d=new MydismissDialog(Shuaka.this,R.style.MyDialog);
							  d.setContentView(R.layout.mydialog);
